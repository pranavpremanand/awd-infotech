      ...
      <div className="wrapper flex lg:flex-row flex-col gap-7 sm:gap-14 justify-between">
        ...
        <div className="flex flex-col lg:flex-row gap-7 sm:gap-14">
            ...
            <ul className="flex flex-col gap-3 mt-1">
              {routes.map(({ path, name }) => (
                <li key={path}>
                  <Link
                    to={path}
                    className="max-w-[22rem] flex gap-2 items-center text-white hover:text-secondary transition-colors duration-200"
                  >
          ...
          <div className="flex flex-col gap-2 text-white">
            ...
            <ul className="flex flex-col gap-3 mt-1">
              {/* <li className="max-w-[22rem] flex gap-3 text-white">
                <MapPin
                  strokeWidth={1.5}
                  size={20}
